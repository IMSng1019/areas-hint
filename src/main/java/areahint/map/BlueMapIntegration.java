...
public final class BlueMapIntegration implements BlueMapBridge {
    ...
    private void syncDimension(String dimensionType) {
        ...
        MarkerSet markerSet = buildMarkerSet(serverWorld, dimensionType);
    ...
    private MarkerSet buildMarkerSet(ServerWorld serverWorld, String dimensionType) {
        ...
        for (AreaData area : areas) {
            try {
                markerSet.getMarkers().put(
                    BlueMapMarkerFactory.createMarkerId(area, dimensionType),
                    BlueMapMarkerFactory.createMarker(area, serverWorld, dimensionType)
                );
            } catch (Exception e) {
