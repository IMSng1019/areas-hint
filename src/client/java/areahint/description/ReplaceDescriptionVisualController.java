...
/**
 * replacedescription 图形流程控制器，只把 Screen 选择转换为现有描述替换流程。
 */
public final class ReplaceDescriptionVisualController {
    ...
    private ReplaceDescriptionVisualController() {
    }
    ...
    public static void openFromCommandUi(Screen parent) {
        ...
        CommandUiActions.runCommandAndClose(parent, "areahint replacedescription");
    }
    ...
    public static void showLoading() {
        setScreen(new MessageScreen(parentScreen,
            "commandui.replacedescription.title",
