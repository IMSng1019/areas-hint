...
/**
 * deletedimensionalitydescription 图形流程控制器，只把界面选择转换为现有维度描述删除流程。
 */
public final class DeleteDimensionalityDescriptionVisualController {
    ...
    private DeleteDimensionalityDescriptionVisualController() {
    }
    ...
    public static void openFromCommandUi(Screen parent) {
        ...
        CommandUiActions.runCommandAndClose(parent, "areahint deletedimensionalitydescription");
    }
    ...
    public static void showLoading() {
        setScreen(new MessageScreen(parentScreen,
            "commandui.deletedimensionalitydescription.title",
    ...
    public static void showFirstConfirm(DescriptionListEntry entry) {
        setScreen(new WizardConfirmScreen(parentScreen,
            ...
            () -> CommandUiActions.runCommand("areahint deletedimensionalitydescription confirm"),
            DescriptionManager.getInstance()::cancel));
    }
    ...
    public static void showSecondConfirm(DescriptionListEntry entry) {
        setScreen(new WizardConfirmScreen(parentScreen,
            ...
            () -> CommandUiActions.runCommand("areahint deletedimensionalitydescription confirm2"),
            DescriptionManager.getInstance()::cancel));
    }
