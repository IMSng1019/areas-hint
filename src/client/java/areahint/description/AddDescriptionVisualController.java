...
/**
 * adddescription 图形流程控制器，只把 Screen 选择转换为现有描述 Manager 流程。
 */
public final class AddDescriptionVisualController {
    ...
    private AddDescriptionVisualController() {
    }
    ...
    public static void openFromCommandUi(Screen parent) {
        ...
        CommandUiActions.runCommandAndClose(parent, "areahint adddescription");
    }
    ...
    public static void showLoading() {
        setScreen(new MessageScreen(parentScreen,
            "commandui.adddescription.title",
