...
/**
 * replacedimensionalitydescription 图形流程控制器，只把界面选择转换为现有维度描述替换流程。
 */
public final class ReplaceDimensionalityDescriptionVisualController {
    ...
    private ReplaceDimensionalityDescriptionVisualController() {
    }
    ...
    public static void openFromCommandUi(Screen parent) {
        ...
        CommandUiActions.runCommandAndClose(parent, "areahint replacedimensionalitydescription");
    }
    ...
    public static void showLoading() {
        setScreen(new MessageScreen(parentScreen,
            "commandui.replacedimensionalitydescription.title",
