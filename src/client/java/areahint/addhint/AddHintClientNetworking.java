 ...
 * AddHint客户端网络通信
 */
public class AddHintClientNetworking {
    ...
    public static void sendToServer(AreaData area, String dimension) {
        try {
            ...
            ClientPlayNetworking.send(BufPayload.of(Packets.ADDHINT_AREA_CHANNEL, buf));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void registerClientReceivers() {
        ClientPlayNetworking.registerGlobalReceiver(
            ...
            (payload, context) -> {
                net.minecraft.network.PacketByteBuf buf = payload.buf();
